...
#
# لذلك جعلنا Flask يبحث عن القوالب في BASE_DIR
# =========================================================
...
def settings_page(page):
    ...
    return render_template(
        f"templates/settings_{page}.html",
        settings=settings
    )
